  ...
  'mbok-jamu': {
    men: {
      ...
      images: [
        ...
        'https://media.loopinsstudio.com/loopinsfe/catalog_page_men_vest_slide4.png',
        'https://media.loopinsstudio.com/loopinsfe/catalog_page_men_vest_slide5.png',
        'https://media.loopinsstudio.com/loopinsfe/catalog_page_men_vest_slide6.png',
      ],
    ...
    women: {
      ...
      showcaseImage: 'https://media.loopinsstudio.com/loopinsfe/catalog_page_women_vest_cover.png',
      price: 649000,
      originalPrice: 749000,
      images: [
        'https://media.loopinsstudio.com/loopinsfe/catalog_page_women_vest_cover.png',
