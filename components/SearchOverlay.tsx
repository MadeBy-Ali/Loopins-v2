...
const PRODUCTS: Product[] = [
  {
    ...
    name: 'Men Vest',
    price: 599000,
    image: 'https://media.loopinsstudio.com/loopinsfe/catalog_page_men_vest_cover.png',
  ...
  },
  {
    ...
    name: 'Women Vest',
    price: 649000,
    image: 'https://media.loopinsstudio.com/loopinsfe/catalog_page_women_vest_cover.png',
    collection: 'mbok-jamu',
    collectionLabel:'Mbok Jamu',
    gender: 'women',
    slug: 'premium-vest'
