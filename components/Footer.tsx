...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-green border-t border-light-cream/10 mt-auto">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <ul className="space-y-3 text-light-cream/70 text-sm">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-soft-brown flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:contact@loopins.com" className="hover:text-soft-brown transition-colors">
                  contact@loopins.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+6281234567890" className="hover:text-soft-brown transition-colors">
                  +62 812 3456 7890
                </a>
              </li>
              <li className="flex items-start gap-2">
